...
package ma.zango.productservice.service.persistence.impl;
...
import ma.zango.productservice.exception.NoSuchProductException;
import ma.zango.productservice.model.Product;
import ma.zango.productservice.model.impl.ProductImpl;
import ma.zango.productservice.model.impl.ProductModelImpl;
import ma.zango.productservice.service.persistence.ProductPersistence;
 ...
 * @see ma.zango.productservice.service.persistence.ProductUtil
 * @generated
 */
@ProviderType
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			...
			ProductModelImpl.LIB_COLUMN_BITMASK);
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LIB = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, ProductImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBylib",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LIB = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, ProductImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBylib",
			new String[] { String.class.getName() },
			ProductModelImpl.LIB_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_LIB = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBylib",
			new String[] { String.class.getName() });

	/**
	 * Returns all the products where lib = &#63;.
	 *
	 * @param lib the lib
	 * @return the matching products
	 */
	@Override
	public List<Product> findBylib(String lib) {
		return findBylib(lib, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the products where lib = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProductModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Product> findBylib(String lib, int start, int end) {
		return findBylib(lib, start, end, null);
	}

	/**
	 * Returns an ordered range of all the products where lib = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProductModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Product> findBylib(String lib, int start, int end,
		OrderByComparator<Product> orderByComparator) {
		return findBylib(lib, start, end, orderByComparator, true);
	}
	...
	public List<Product> findBylib(String lib, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LIB;
			finderArgs = new Object[] { lib };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LIB;
			finderArgs = new Object[] { lib, start, end, orderByComparator };
		}
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Product product : list) {
					if (!Objects.equals(lib, product.getLib())) {
						list = null;
		...
		if (list == null) {
			...
			boolean bindLib = false;

			if (lib == null) {
				query.append(_FINDER_COLUMN_LIB_LIB_1);
			}
			else if (lib.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_LIB_LIB_3);
			}
			else {
				bindLib = true;

				query.append(_FINDER_COLUMN_LIB_LIB_2);
			}
	...
	/**
	 * Returns the first product in the ordered set where lib = &#63;.
	 *
	 * @param lib the lib
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching product
	 ...
	 */
	@Override
	public Product findBylib_First(String lib,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = fetchBylib_First(lib, orderByComparator);
	 ...
	 */
	@Override
	public Product fetchBylib_First(String lib,
		OrderByComparator<Product> orderByComparator) {
		List<Product> list = findBylib(lib, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last product in the ordered set where lib = &#63;.
	 *
	 * @param lib the lib
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching product
	 ...
	 */
	@Override
	public Product findBylib_Last(String lib,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = fetchBylib_Last(lib, orderByComparator);
	 ...
	 */
	@Override
	public Product fetchBylib_Last(String lib,
		OrderByComparator<Product> orderByComparator) {
		int count = countBylib(lib);

		if (count == 0) {
			return null;
		}

		List<Product> list = findBylib(lib, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the products before and after the current product in the ordered set where lib = &#63;.
	 *
	 * @param productId the primary key of the current product
	 * @param lib the lib
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Product[] findBylib_PrevAndNext(long productId, String lib,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = findByPrimaryKey(productId);
		...
		try {
			...
			array[0] = getBylib_PrevAndNext(session, product, lib,
					orderByComparator, true);

			array[1] = product;

			array[2] = getBylib_PrevAndNext(session, product, lib,
					orderByComparator, false);
	...
	protected Product getBylib_PrevAndNext(Session session, Product product,
		String lib, OrderByComparator<Product> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the products where lib = &#63; from the database.
	 *
	 * @param lib the lib
	 */
	@Override
	public void removeBylib(String lib) {
		for (Product product : findBylib(lib, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(product);
		}
	}
	...
	/**
	 * Returns the number of products where lib = &#63;.
	 *
	 * @param lib the lib
	 * @return the number of matching products
	 */
	@Override
	public int countBylib(String lib) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_LIB;

		Object[] finderArgs = new Object[] { lib };
	...
	private static final String _FINDER_COLUMN_LIB_LIB_1 = "product.lib IS NULL";
	private static final String _FINDER_COLUMN_LIB_LIB_2 = "product.lib = ?";
	private static final String _FINDER_COLUMN_LIB_LIB_3 = "(product.lib IS NULL OR product.lib = '')";
	...
	public Product updateImpl(Product product) {
		...
		if (!ProductModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { productModelImpl.getLib() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_LIB, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LIB,
				args);
			...
			if ((productModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LIB.getColumnBitmask()) != 0) {
				Object[] args = new Object[] { productModelImpl.getOriginalLib() };
	...
	protected Product toUnwrappedModel(Product product) {
		...
		productImpl.setLib(product.getLib());
		productImpl.setPrix(product.getPrix());
		productImpl.setDateMiseVente(product.getDateMiseVente());
