...
package zango.demo.core.service.persistence;
...
/**
 * The persistence utility for the produit service. This utility wraps {@link zango.demo.core.service.persistence.impl.ProduitPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see zango.demo.core.service.persistence.impl.ProduitPersistenceImpl
 * @generated
 */
@ProviderType
public class ProduitUtil {
	 ...
	 */
	public static List<Produit> findWithDynamicQuery(DynamicQuery dynamicQuery) {
	 ...
	 */
	public static Produit update(Produit produit, ServiceContext serviceContext) {
	...
	*/
	public static Produit create(int idProduit) {
		return getPersistence().create(idProduit);
	}
	...
	*/
	public static Produit remove(int idProduit)
		throws zango.demo.core.exception.NoSuchProduitException {
		return getPersistence().remove(idProduit);
	}
	...
	* @throws NoSuchProduitException if a produit with the primary key could not be found
	*/
	public static Produit findByPrimaryKey(int idProduit)
		throws zango.demo.core.exception.NoSuchProduitException {
		return getPersistence().findByPrimaryKey(idProduit);
	}
	...
	*/
	public static Produit fetchByPrimaryKey(int idProduit) {
		return getPersistence().fetchByPrimaryKey(idProduit);
	}

	public static java.util.Map<java.io.Serializable, Produit> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<ProduitPersistence, ProduitPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ProduitPersistence.class);
}