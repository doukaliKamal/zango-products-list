...
/**
 * Provides the local service interface for Produit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProduitLocalServiceUtil
...
public interface ProduitLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProduitLocalServiceUtil} to access the produit local service. Add custom service methods to {@link zango.demo.core.service.impl.ProduitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public void saveProduct(java.lang.String lib, long prix, Date dateMiseVente);
